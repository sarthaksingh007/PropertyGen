    ...
    <div
      className={
        showChatbot
          ...
          : "dm mx-auto sm:w-2/4 w-11/12 bg-[#FFFFFF]   bg-opacity-100 mb-16 rounded-lg border-1 border-[#D6D6E6] shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]"
      }
    >
      <div
        className={
      ...
      <div
        className={
          showChatbot
            ...
            : "messages-container sm:h-50 h-[30vh] mx-auto sm:w-full w-full rounded-lg my-2 overflow-auto"
        }
      >
      ...
      <form
        ...
        className={
          showChatbot
            ...
            : "flex flex-row sm:justify-between justify-center sm:items-start px-1 rounded-lg items-center py-2 sm:flex-nowrap flex-wrap"
        }
      >
        <div className="flex flex-row justify-between items-center sm:w-full w-full border-2 border-gray-200 sm:mx-1 rounded-md mb-4">
          <input
            type="text"
            value={inputText}
            className="sm:w-full rounded-md px-1 text-md my-0 min-h-[40px] resize-none w-full focus:outline-none bg-[#f0f6fb]"
        ...
        <button
          ...
          className="flex sm:w-1/4  w-full flex-row  justify-center items-center bg-[#8CAFFD] text-black text-md px-2 rounded-lg py-2 relative h-10 sm:text-[10.5px]"
        >
          {isLoading ? (
