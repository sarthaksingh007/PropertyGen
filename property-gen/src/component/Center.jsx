...
const Center = () => {
  ...
  return (
    <div className="hero2">
      ...
      >
        <h1 className="text-left sm:ml-1 ml-5 text-white sm:text-4xl text-2xl sm:w-2/4 w-11/12 font-extrabold my-2 mb-7">
        ...
        <div className="flex flex-wrap justify-evenly items-center">
          {features.map((feature, index) => (
            <div
              key={index}
              className="flex flex-col justify-center items-center sm:p-2 p-1 my-6 custom-gradient2 relative sm:m-7 m-2 rounded-2xl sm:w-1/4 w-2/5 gradient-border sm:h-84 h-[20rem]"
            >
              <img
                src={feature.image}
                alt=""
                className="absolute sm:top-[-40px] sm:left-4 top-[-20px] left-2 sm:w-[25%] w-10"
              />
